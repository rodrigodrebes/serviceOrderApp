...
public class TelaSobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Desenvolvido por Tech Solutions.");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("Desenvolvido para atender os requisitos de negócio da Empresa X.");

        jLabel3.setText("Fale conosco em: techsolutions@gmail.com");
